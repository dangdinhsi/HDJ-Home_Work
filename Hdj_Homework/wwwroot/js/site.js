...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function validate() {
        ...
        var nameMessage = document.getElementsByName("messageName")[0];
        var emailMassage = document.getElementsByName("messageEmail")[0];
        var phoneMassage = document.getElementsByName("messagePhone")[0];
        var check = true;
        if (name.length === 0) {
